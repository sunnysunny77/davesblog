...
<body id="top" class="d-flex flex-column p-2 p-md-3 px-xxl-5 py-xxl-4">
    ...
    <header class="container-fluid d-flex justify-content-between align-items-center">
        <form id="blog-form" class="d-flex flex-row align-self-end mb-1" action="?action=search" method="post">
            <label for="search" class="d-none">Search title</label>
            <button class="p-0" type="submit" name="submit">
            ...
            <input id="search" type="text" name="search" placeholder="Search title" />
        </form>
