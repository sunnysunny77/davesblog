<div>
    ...
    $page = isset($_GET["page"]) ? '?page=' . $_GET["page"] : '?page=' . 1;
        ...
        echo '<img class="mb-md-3 ms-2" width="50" height="50" alt="' .  pathinfo($this->result["filename"], PATHINFO_FILENAME) . '" src="data:' . $this->result["mimetype"] . ';base64,' . base64_encode($this->result['filedata']) . '" >';
        echo '</div>';
        echo '</div>';
